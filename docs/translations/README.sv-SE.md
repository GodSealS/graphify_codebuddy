...
> **Officiellt paket:** PyPI-paketet heter `graphifyy`. Det enda officiella förrådet är [GodSealS/graphify_codebuddy](https://github.com/GodSealS/graphify_codebuddy).
