...
> **Pacchetto ufficiale:** Il pacchetto PyPI si chiama `graphifyy`. L'unico repository ufficiale è [GodSealS/graphify_codebuddy](https://github.com/GodSealS/graphify_codebuddy).
