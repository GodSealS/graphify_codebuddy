...
## For the commit hook and native CodeSquad integration

When the user asks to install the post-commit auto-rebuild hook or wire graphify into CodeSquad, see `references/hooks.md`.
